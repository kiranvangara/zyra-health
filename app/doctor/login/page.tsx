...
export default function DoctorLogin() {
    ...
    return (
        <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px', background: 'white' }}>
            ...
            />
            <h2 style={{ color: '#333', marginBottom: '5px' }}>Medivera</h2>
            ...
            <div style={{ marginTop: '30px', fontSize: '12px', color: '#888', textAlign: 'center', lineHeight: '1.5', maxWidth: '300px' }}>
                <b>Not yet on Medivera?</b><br />
                Our platform is invite-only. To join our network of verified specialists, please <u style={{ cursor: 'pointer', color: '#28a745' }} onClick={() => alert('Please email partners@medivera.com')}>contact our partner team</u>.
            </div>
        </div>
    );
}
