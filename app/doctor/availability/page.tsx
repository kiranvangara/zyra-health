...
const TIMEZONES = [
    'UTC', 'Asia/Kolkata', 'America/New_York', 'Europe/London', 'Asia/Dubai', 'Australia/Sydney'
];
...
export default function AvailabilitySettings() {
    ...
    const fetchSettings = async () => {
        ...
        const { data } = await supabase
            .from('doctors')
            .select('weekly_schedule, time_zone')
            .eq('id', user.id)
            .single();
    ...
    return (
        <div style={{ minHeight: '100vh', background: '#f8f9fa', paddingBottom: '80px' }}>
            <div className="glass-header" style={{ justifyContent: 'center' }}>
